...
def main():
    print 'getting dicts'
    beta_dict_binary, tms_dict_all, kin_dict_all = get_binary_events()
    analyze_kin_in_binary_events([25, 40], 60, 100, beta_dict_binary, tms_dict_all, kin_dict_all)
